...
const WhatsAppButton = () => {
  ...
  return (
    <a
      ...
      data-track="btn-lead"
      className="fixed bottom-5 right-5  bg-[#25D366] hover:bg-[#1EBE57] text-white p-3 rounded-full shadow-lg transition-all duration-300 z-50 flex items-center justify-center"
